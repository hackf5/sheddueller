...
internal sealed class ConcurrencyGroupManager : IConcurrencyGroupManager
{
  private readonly ITaskStore store;
  private readonly TimeProvider timeProvider;
  private readonly IShedduellerWakeSignal wakeSignal;

  public ConcurrencyGroupManager(ITaskStore store, TimeProvider timeProvider, IShedduellerWakeSignal wakeSignal)
  {
    this.store = store;
