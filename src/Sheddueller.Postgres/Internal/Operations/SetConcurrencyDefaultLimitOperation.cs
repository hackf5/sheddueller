...
internal static class SetConcurrencyDefaultLimitOperation
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await PostgresOperationContext.ExecuteCountAsync(
          ...
          transaction,
          $"""
          insert into {context.Names.ConcurrencyGroups} (group_key, configured_limit, default_limit, in_use_count, updated_at_utc)
          values (@group_key, null, @default_limit, 0, transaction_timestamp())
          ...
          command =>
          {
              ...
              command.Parameters.AddWithValue("default_limit", request.Limit);
          },
          cancellationToken)
